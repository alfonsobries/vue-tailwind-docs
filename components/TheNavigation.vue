        ...
        <div class="relative z-50 flex items-center justify-between h-16">
            ...
            <div class="hidden lg:block lg:ml-6">
              <div class="flex">
                <nuxt-link
                  ...
                  :key="index"
                  :to="item.to"
                  class="px-3 py-1 ml-4 text-sm font-medium leading-5 text-gray-500 transition duration-150 ease-in-out rounded-md hover:bg-gray-200 focus:outline-none focus:bg-gray-200"
          ...
          <div class="hidden lg:block lg:ml-4">
            <div class="flex items-center">
              <a href="https://twitter.com/alfonsobries" target="_blank" class="text-gray-500 hover:text-gray-700">
              ...
              <a href="https://github.com/alfonsobries/vue-tailwind" target="_blank" class="mx-6 text-gray-500 hover:text-gray-700">
                ...
                >
                  ...
                  >
                    ...
                    <span class="flex flex-col text-sm leading-none text-left">
                      ...
                      <span class="font-semibold text-gray-500">BTC</span>
                    </span>
                  </button>
                </div>
                <template>
