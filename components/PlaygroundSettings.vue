<template>
  <div class="max-w-full overflow-auto">
    <tip class="border-b text-sm leading-5 items-stretch">
      In this tab you can view, download and copy the settings to make your theme look like the <a href="#" class="underline font-medium" @click.prevent="$emit('select', 'demo')">demo</a>. If you want to modify these settings use the <a href="#" class="underline font-medium" @click.prevent="$emit('select', 'customize')">customize</a> tab.
    </tip>
    <div class="p-4">
