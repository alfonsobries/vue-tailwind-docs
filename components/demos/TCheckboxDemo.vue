<template>
  <div>
    <tip v-show="!settings.wrapped" class="border-b text-sm leading-5 items-stretch" closable>
      Notice that the checkbox inputs ignore most of the CSS classes. For the demo below we use the <a class="underline" href="https://github.com/tailwindcss/custom-forms">tailwind custom forms plugin</a> that adds the `<i>form-checkbox</i>` class that make the input more customizable.
    </tip>
    <div class="p-4">
