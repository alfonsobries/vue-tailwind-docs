  ...
  <div>
    ...
    <footer>
      <div class="px-6 bg-orange-200">
        <div class="max-w-screen-xl mx-auto py-16 lg:flex lg:items-center">
          <div class="lg:w-0 lg:flex-1">
            <h2 id="newsletter-headline" class="text-2xl leading-9 font-semilbold tracking-tight text-orange-700 sm:text-4xl sm:leading-10">
              Sign up for our newsletter
            </h2>
            <p class="mt-3 max-w-3xl text-orange-500">
              Stay up-to-date on news and updates about this project by email.
            </p>
          </div>
          <div class="mt-8 lg:mt-0 lg:ml-8 max-w-md">
