    ...
    <div class="bg-gray-800 mt-5 text-gray-400">
      <div class="container mx-auto flex justify-between py-8">
        <div class="flex justify-center md:order-2">
          ...
          <a href="https://github.com/alfonsobries" target="_blank" class="ml-6 text-gray-400 hover:text-gray-500">
        ...
        <div class="mt-8 md:mt-0 md:order-1">
          <p class="text-center text-base leading-6 text-gray-400 inline-flex items-center">
            Made with
            <icon class="h-5 w-5 mx-2 text-gray-400">
              <path d="M10 3.22l-.61-.6a5.5 5.5 0 0 0-7.78 7.77L10 18.78l8.39-8.4a5.5 5.5 0 0 0-7.78-7.77l-.61.61z" />
            </icon>
            by&nbsp;<a href="https://twitter.com/alfonsobries" target="_blank">Alfonso Bribiesca </a>
          </p>
        </div>
      </div>
    </div>
